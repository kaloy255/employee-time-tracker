...
<body class=" min-h-screen bg-gradient-to-br from-[#29282F] to-[#09080F] text-white urbanist flex flex-col gap-20">
    ...
    <main class="self-center w-full flex flex-col items-center gap-40 h-full">
        <div id="border-timer" class="flex flex-col items-center gap-5 border border-[#38373E] rounded-lg w-1/3 py-10">
            ...
            <div>
                ...
                <form id="timeInForm" method="POST">
                    <button type="submit" id="timeInButton" name="start"
                        class="bg-gradient-to-r from-[#24D9E8] to-[#9C0777] rounded-full py-3 px-10 text-xl flex items-center gap-2"><img
                            src="assets/start-icon.svg" alt=""> <span>START</span></button>
                </form>
                <!-- stop button -->
                <form id="timeOutForm" method="POST" style="display: none;">
                    <button type="submit" id="timeOutButton" name="stop"
                        class="bg-[#29282F] rounded-full py-3 px-10 text-xl flex items-center gap-2"> <img
                            src="assets/stop-icon.svg" alt=""> <span>STOP</span></button>
                </form>
            </div>
        </div>
        ...
        <div class="w-1/2">
            ...
            <div class="text-center mt-5"><a href="history.php"
                    class="px-5 py-2 bg-[#62F3FF] rounded-full text-black font-semibold">Review Past Entries</a></div>
        </div>
